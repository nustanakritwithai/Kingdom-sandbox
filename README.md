...
- ตรวจว่า deploy ถูก: หน้าเว็บควรมีปุ่ม **💾 Save**, badge **v13** ใน toolbar
- ถ้า Render ยัง deploy จาก `cursor/living-kingdom-sandbox-246b` ให้เปลี่ยนเป็น `main` ใน Dashboard (Blueprint ไม่ได้อัปเดต branch ของ service เก่าอัตโนมัติเสมอ)
